...
def launch_setup(context, *args, **kwargs):
    ...
    # Build the list of composable nodes dynamically
    composable_nodes = [
        ComposableNode(
    ...
    # Conditionally add ServoNode only if NOT in inference mode
    if inference_mode.perform(context) not in ('True', 'true'):
